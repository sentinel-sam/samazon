...
userRouter.put('/profile', isAuth, expressAsyncHandler(async (req, res) => {
    ...
    if (user) {
        ...
        res.send({ _id: updatedUser._id, name: updatedUser.name, email: updatedUser.email, isAdmin: updatedUser.isAdmin, isSeller: user.isSeller, token: generateToken(updatedUser) });
    }
}));
